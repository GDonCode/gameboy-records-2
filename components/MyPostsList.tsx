...
export default function MyPostsList({ posts, onCreateNew, onEditPost }: MyPostsListProps) {
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      {posts.length === 0 ? (
        <p className="text-white/50" style={{ fontFamily: "'Poppins', monospace" }}>
        ...
        <div className="flex flex-col gap-3">
          {posts.map((post) => (
            ...
            >
              <div>
                <div className="text-white text-[0.95em] mb-1" style={{ fontFamily: "'Poppins', monospace" }}>
                  {post.title}
                </div>
                <div className="flex gap-2.5 items-center">
                  ...
                  <span className="text-[0.75em] text-white/40" style={{ fontFamily: "'Poppins', monospace" }}>
                    {post.tag}
                  </span>
                </div>
              </div>
