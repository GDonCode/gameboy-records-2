...
<!-- CUSTOMER LEFT | ORDER DATA RIGHT -->
	...
	<tr>
		<td class="address billing-address">
			...
			<?php if ( $this->show_shipping_address() ) : ?>
				<div class="ship-to-label"><strong><?php $this->shipping_address_title(); ?></strong></div>
...
<!-- TOTALS right-anchored, barcode below total -->
	...
	<tbody>
		<tr class="no-borders">
			...
			<td class="no-borders totals-cell">
				...
				<!-- BARCODE below totals, right-aligned -->
				<div class="barcode-wrap">
					<barcode code="<?php echo esc_attr( $this->order->get_order_number() ); ?>" type="C128" class="barcode" />
					<div class="barcode-label"><?php $this->order_number(); ?></div>
				</div>
			</td>
		</tr>
	</tbody>
